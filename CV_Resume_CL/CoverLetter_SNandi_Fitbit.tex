...
% https://www.fitbit.com/jobs/search?jvs=LinkedIn#apply/ot2B1fwR
% Research Scientist, Data - Intern
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%% Qualifications:
%% A successful candidate will have deep experience in applying machine learning and statistics toward understanding structured and unstructured data.  
%% Research responsibilities will include exploratory data analysis, data visualization, and developing prototypes and metrics to drive product and business decisions. 
%% You must be curious -- someone who can propose new data-based features and analyses  -- and you must also be capable of executing them soup to nuts in a prototype capacity.
%% Pursuing Ph.D./M.S. in Statistics, Applied Mathematics, or Computer Science.
%% Mastery of machine learning and data mining: classification, clustering, time-series analysis, recommender systems.  Must be comfortable with working with real data.
%% Proficient with statistical or numerical analysis tools (R, Matlab)
%% Experience with Java, Stripes, Spring, mySQL, Solr, and distributed ehcache.  A big plus if you can build simple web front ends to demo new data-based features
