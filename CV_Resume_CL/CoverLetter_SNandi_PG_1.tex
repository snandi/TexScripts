...
% https://pg.taleo.net/careersection/10000/jobdetail.ftl?job=IT+00000657
% Data Scientist – Internship (PhD Only)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%% Demonstrated success in effective leadership, problem solving and priority setting and 
%% leveraging advanced analytic techniques (Machine Learning, Data Mining, Optimization, Simulation, etc)
%% Experience leveraging "big data" tools such as Hadoop in a wide variety of real life applications in 
%% a corporate setting
...
I am a PhD student in statistics at the University of Wisconsin - Madison. I would like to apply for the ``Business Analytics / Data Scientist - Internship'' position at Proctor \& Gamble, starting from June, 2016. I came across the position on Chegg.com's internships portal.
...
I admire P\&G's mission of serving consumers across the world with the best brands in the market. As a data scientist, I will be uniquely placed to contribute towards that mission. I will enjoy contributing to better decision-making through the usage of advanced data science. I will be a great fit for the Data Scientist internship position at P\&G. I am available for a phone interview on most weekdays. I look forward to hearing back from you.
