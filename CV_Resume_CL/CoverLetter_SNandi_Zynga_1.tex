...
% http://app.jobvite.com/CompanyJobs/Job.aspx?c=qoX9Vfw9&j=oH6f2fwO
% Data Science Intern
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%% Requirements:
%% Obtaining a degree in Computer Science, Math, Statistics, Economics, or other quantitative field; Masters or PhD strongly preferred
...
%% Fluent in SQL
%% Fluent in some or all of the following: SAS, STATA, R, Python, C++ 
