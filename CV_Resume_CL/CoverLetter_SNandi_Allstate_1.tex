...
% http://allstate.jobs/ShowJob/Id/646005/Marketing%20Data%20Scientist%20Summer%20Intern
% Marketing Data Scientist Summer Intern
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%% The Marketing Data Science intern will be assigned a specific or series of projects that will entail developing analytic models that will contribute to marketing program optimization.  The intern will collaborate with existing team members for guidance and project delivery.  The marketing analytics team is comprised of data engineers, data scientist, digital media experts, and analytic solution consultants. 

%%Key Responsibilities
%% Develop data science and applied analytic solutions using marketing data sets 
%% Work with digital data, marketing technologies, and Allstate systems to create custom analytics
%% Coordinate own work plan and prioritize workflow and projects
%% Partner with data scientists and digital media optimization analysts to deliver a short term analytics product. 
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
I am a PhD student in statistics at the University of Wisconsin - Madison. I would like to apply for ``Marketing Data Scientist Summer Intern'' position at Allstate, starting from June, 2016. I came across the position on the LinkedIn.
...
I will be a great fit for the Data Research Scientist intern position at Allstate. I am available for a phone interview on most weekdays. I look forward to hearing back from you.
