...
## _createDagSubmitFile_RS11-08_singleIter_redo.sh "Run09_3" 1 300 > dagSubmit_Run09_3_singleIter_redo.dag
...
do
    DataFile="/z/Proj/newtongroup/snandi/Simulation_Registration/$runID/Seed$Seed/RegData_singleIter_Seed$Seed.RData"
    if [ ! -f "$DataFile" ];
    then
    	jobID="Seed"$Seed
