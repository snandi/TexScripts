...
## _createDagSubmitFile_RS11-08_permute_Iterated.sh /z/Proj/newtongroup/snandi/Simulation_Registration/Run09_2/SeedCombs_forPower.txt 1 500 > dagSubmit_Run09_2_permute_Iterated.dag
...
do
    ...
    echo "JOB $jobID /z/Proj/newtongroup/snandi/Project_CurveReg/SubmitFiles/submitFile_CurveReg_RS11-08_permute_Iterated.txt"
