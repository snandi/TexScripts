...
## _createDagSubmitFile_RS12-04.sh /z/Proj/newtongroup/snandi/mm52-all7341/alignmentChunks/chr13_Length30_Depth10.txt > dagSubmit_chr13.dag
...
do
	...
	echo "JOB $jobID /z/Proj/newtongroup/snandi/Project_CurveReg/SubmitFiles/submitFile_CurveReg_RS12-04.txt"
