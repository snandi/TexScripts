...
\begin{center}
\begin{tikzpicture}
  \node (img1) {\includegraphics[scale=0.30]{molecule251_frame68.png}};
  \pause
  \node (img2) at (img1.north)[yshift=-3cm] {\includegraphics[scale=0.25, page=1]{Frag38_2.pdf}};
\end{tikzpicture}
\end{center}
\end{frame}
...
\begin{figure}
\includegraphics[scale=0.45, page=2]{Frag38_2.pdf}
\end{figure}
\end{frame}
