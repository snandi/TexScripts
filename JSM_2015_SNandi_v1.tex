...
%  \usepackage{colortbl} %added for \usetheme{TUGraz}
...
\begin{figure}
\includegraphics[width=0.113\textwidth]{RibosomalDNA_2015-03-19.pdf}%
\includegraphics[width=0.29\textwidth]{RibosomalDNA_2015-03-19.pdf}
\caption{{\footnotesize SNPs are clustered into three groups based on their annotations and associations measures.}}
  \end{figure}
  \end{column}
            \begin{column}{.41\textwidth}
\begin{figure}  
\includegraphics[width=.64\textwidth]{RibosomalDNA_2015-03-19.pdf}
...
\begin{figure}[p]
  \centering
  \includegraphics[width=0.3\linewidth]{RibosomalDNA_2015-03-19.pdf}
